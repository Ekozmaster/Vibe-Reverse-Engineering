...
namespace comp
{
	...
	// FEAR.exe registers exactly one window class via RegisterClassW at 0x0047de58
	// with lpszClassName = L"FEAR" at 0x00554744. The same function then calls
	// CreateWindowExA at 0x0047deb5 with the ANSI duplicate "FEAR" at 0x0055446C.
	// The ANSI form is what GetClassNameA in enum_windows_proc reads.
	#define WINDOW_CLASS_NAME "FEAR"
