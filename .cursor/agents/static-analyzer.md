...
| Need | Go to |
|------|-------|
| Full tool syntax, flags, caveats for any retools/DX-script/dumpinfo tool, and run-directly vs delegate guidance | `.cursor/rules/tool-catalog.mdc` |
| Bootstrap ordering, parallel dual-backend runs, delegation table | `.cursor/rules/subagent-workflow.mdc` |
